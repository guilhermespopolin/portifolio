          ...
          <div className="flex flex-col gap-4 md:basis-full">
            ...
            <div>
              ...
              <p className="text-justify">
                ...
                in ornare ipsum, id dapibus magna. Nulla facilisi. Integer nisl
                elit, euismod quis erat sed, convallis condimentum arcu. Aenean
                sit amet suscipit augue, eu finibus ex. Nulla ut mattis tortor.
                Aliquam a fringilla ex, non posuere diam. Pellentesque a metus
                in tortor ultrices ullamcorper vel sed purus. Maecenas ultrices
                erat non rhoncus vehicula. Duis faucibus vel massa et fringilla.
                Phasellus ut lacinia felis. Mauris id justo nec ante ultricies
                venenatis. In hac habitasse platea dictumst. Suspendisse eget
                turpis ante. Duis maximus tempor scelerisque. Curabitur dolor
                ex, volutpat id nulla quis, bibendum aliquet dui. Praesent orci
                nibh, placerat at iaculis ut, facilisis eu diam. Quisque aliquet
                consequat est, vulputate malesuada tortor mattis pharetra. Morbi
                dui eros, lacinia non nisl vel, gravida auctor purus.
              </p>
            </div>
          </div>
        </div>
